...
export const WORDS: Word[] = [
  ...
  { mot: "ANA", defs: ["Recueil de bons mots d'un auteur", "Florilège de propos célèbres"], lettres: 3, cat: "culture" },
  { mot: "ANI", defs: ["Oiseau des Antilles à bec crochu", "Coucou noir des tropiques américains"], lettres: 3, cat: "animal" },
  ...
  { mot: "ARE", defs: ["Unité de mesure de surface valant 100 m²", "Dixième de l'hectare"], lettres: 3, cat: "science" },
  ...
  { mot: "AVAL", defs: ["En amont/__ : dans le sens du courant", "Vers l'embouchure"], lettres: 4, cat: "nature" },
  ...
  { mot: "ETA", defs: ["Septième lettre de l'alphabet grec (η)", "Lettre grecque entre dzêta et thêta"], lettres: 3, cat: "divers" },
  { mot: "GNU", defs: ["Grande antilope africaine à barbe", "Gnou des savanes"], lettres: 3, cat: "animal" },
  ...
  { mot: "ILL", defs: ["Rivière alsacienne qui traverse Strasbourg", "Affluent du Rhin en Alsace"], lettres: 3, cat: "géo" },
  ...
  { mot: "LAD", defs: ["Garçon d'écurie", "Jockey apprenti"], lettres: 3, cat: "sport" },
  ...
  { mot: "LORI", defs: ["Petit perroquet coloré d'Océanie", "Psittacidé nectarivore des îles du Pacifique"], lettres: 4, cat: "animal" },
  { mot: "NAOS", defs: ["Sanctuaire intérieur d'un temple grec", "Partie centrale de la cella"], lettres: 4, cat: "archi" },
  ...
  { mot: "OCA", defs: ["Plante andine à tubercules comestibles", "Oxalis cultivé des Andes"], lettres: 3, cat: "nature" },
  { mot: "ODE", defs: ["Poème lyrique chanté", "Pièce de vers destinée au chant"], lettres: 3, cat: "culture" },
  ...
  { mot: "ORLE", defs: ["Bordure héraldique en retrait du bord", "Pièce honorable de l'écu"], lettres: 4, cat: "objet" },
  ...
  { mot: "TAO", defs: ["Principe fondamental de la philosophie chinoise", "Voie cosmique du taoïsme"], lettres: 3, cat: "culture" },
  ...
  { mot: "YAK", defs: ["Bovidé domestique du Tibet", "Bœuf à long poil des hauts plateaux himalayens"], lettres: 3, cat: "animal" },
